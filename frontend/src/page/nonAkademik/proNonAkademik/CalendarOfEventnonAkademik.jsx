...
export default function CalendarOfEventnonAkademik() {
      ...
      try {
        ...
        const mappedEvents = data.map((item, index) => {
          ...
          return {
            ...
            // Menggunakan skema warna Biru Cyan sesuai permintaan
            ...
            extendedProps: {
              category: item.kode_program || "Non-Akademik",
  ...
  return (
    <PageWrapper className="h-screen bg-[#F0F9FF] flex overflow-hidden !p-0 font-sans selection:bg-[#0AC4E0]/30">
      ...
      {/* Background Decor - Blue Cyan Blobs */}
      ...
      <main className="flex-1 flex flex-col h-full overflow-hidden px-6 py-6 animate-in fade-in duration-700">
          ...
          <div className="flex items-center gap-5">
            ...
            <div>
              <h1 className="text-2xl font-black text-white tracking-tight uppercase leading-none">
                Non-Academic <span className="opacity-70 font-medium italic text-sm normal-case tracking-normal">Schedule</span>
              </h1>
              <p className="text-white/70 text-[10px] font-black uppercase tracking-[0.2em] mt-2">
                Sistem Penjadwalan Operasional
              </p>
            </div>
          </div>
        ...
        <div className="flex-1 overflow-hidden grid grid-cols-1 xl:grid-cols-12 gap-6">
          ...
          <div className="xl:col-span-8 flex flex-col h-full overflow-hidden">
            <div className="flex-1 bg-white border border-gray-100 rounded-[2.5rem] shadow-sm p-6 overflow-hidden flex flex-col">
              <style>{`
                ...
                .fc-day-today { background-color: rgba(10, 196, 224, 0.05) !important; }
          ...
          <div className="xl:col-span-4 flex flex-col h-full overflow-hidden">
            <div className="flex-1 bg-white border border-gray-100 rounded-[2.5rem] shadow-sm overflow-hidden flex flex-col leading-none">
              <div className="p-6 bg-slate-50/50 border-b border-gray-100 flex items-center justify-between">
                ...
                <span className="text-[10px] font-bold bg-white px-3 py-1 rounded-full border border-gray-100 text-slate-400">Daftar</span>
              </div>
              ...
              {/* Informational Widget inside Sidebar */}
              <div className="p-6 bg-gradient-to-tr from-[#0AC4E0] to-[#58e2f3] m-4 rounded-3xl text-white relative overflow-hidden shadow-lg">
                <div className="relative z-10">
                  <p className="text-[10px] font-black uppercase tracking-widest opacity-80 mb-1">Update Info</p>
                  <p className="text-xs font-medium leading-snug">Jadwal non-akademik tersinkronisasi otomatis dengan server pusat YPA-MDR.</p>
                </div>
