...
const CreateWilayah = () => {
  ...
  const validateForm = () => {
    ...
    const province = findProvinceByName(formData.provinsi);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setStatusNote({
        show: true,
        type: "success",
        message: "Data provinsi berhasil ditambahkan sebagai wilayah.",
      });
      ...
      setStatusNote({
        ...
        message:
          ...
          "Gagal menambahkan data wilayah provinsi.",
      });
    } finally {
      setLoading(false);
    }
            ...
            <header className="flex items-center justify-between">
              <div>
                ...
                <h1 className="text-xl font-black uppercase text-gray-800">
                  Tambah Data <span className="text-[#0AC4E0]">Wilayah</span>
                </h1>
              </div>
          ...
          >
                  ...
                  <div className="mb-4 flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-[9px] font-bold text-gray-400">
                        Pilih satu provinsi dari data master Indonesia.
                      </p>
                    </div>
                  </div>
                ...
                <div className="rounded-3xl border border-slate-100 bg-slate-50/50 p-5">
                  <div className="mb-4 flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-[9px] font-bold text-gray-400">
                        Data otomatis dari master provinsi.
                      </p>
                    </div>
                  </div>
            ...
            <div className="flex min-h-0 flex-col gap-5 border-l border-gray-100 p-7">
              ...
              <div className="flex shrink-0 items-center justify-between border-t border-gray-100 pt-5">
                ...
                <Button
                  text={loading ? "Menyimpan..." : "Simpan Wilayah"}
                  icon={<Save size={15} />}
